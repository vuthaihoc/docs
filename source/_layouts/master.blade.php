...
<header class="flex items-center h-24 py-4 bg-white relative" role="banner">
    <div class="container flex items-center mx-auto px-4 lg:px-8">
        <div class="flex items-center">
            <!-- Desktop Logo -->
            <a href="{{ $page->baseUrl }}/" title="{{ $page->siteName }} home" class="hidden md:inline-flex items-center">
                {!! file_get_contents(__DIR__ . "/../source/assets/img/logo.svg") !!}
            </a>
            <!-- Mobile Logo -->
            <a href="{{ $page->baseUrl }}/" title="{{ $page->siteName }} home" class="inline-flex md:hidden items-center">
        ...
        <div class="flex flex-1 justify-end items-center text-right md:pl-10">
            ...
            @endif
            <a href="{{$page->baseUrl}}/docs/quickstart" class="ml-6 text-blue-800">Docs</a>
            <a href="https://forum.laravel-livewire.com" class="ml-6 text-blue-800">Forum</a>
            <a href="{{$page->baseUrl}}/podcast" class="ml-6 text-blue-800">Podcast</a>
